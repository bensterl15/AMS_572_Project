...
Table \ref{tab:model_info} contains the results. The full model, model 3, is the best overall model to choose to estimate temperature because it has the highest Adjusted $R^{2}$ and lowest AIC and BIC values.
